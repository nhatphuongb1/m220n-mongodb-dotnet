    ...
    public class MoviesRepository
    {
        ...
        public async Task<Movie> GetMovieAsync(string movieId, CancellationToken cancellationToken = default)
        {
            try
            {
                return await _moviesCollection.Aggregate()
                    .Match(x => x.Id == movieId)
                    .Lookup(_commentsCollection, m => m.Id, c => c.MovieId,
                    (Movie m) => m.Comments)
            ...
            )
        {
            ...
            return await _moviesCollection
               .Find(x => x.Countries.Any(country => countries.Contains(country)))
            ...
            int page = 0, params string[] genres)
        {
            ...
            return await _moviesCollection
                   .Find(x => x.Genres.Any(g => genres.Contains(g)))
                   .Limit(limit)
                   .Skip(page * limit)
                   .Sort(sort)
                   .ToListAsync(cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
           ...
           */
            ...
            result.Count = (int)count.Values.FirstOrDefault();
